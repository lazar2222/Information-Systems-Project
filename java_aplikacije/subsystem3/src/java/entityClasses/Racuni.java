...
public class Racuni implements Serializable {
    ...
    @JoinColumn(name = "IDMestaOtvaranja", referencedColumnName = "IDMesta")
    @ManyToOne(optional = false)
    private Mesta iDMestaOtvaranja;
    ...
    public Racuni(Integer iDRacuna, long stanje, long dozvoljenMinus, Character status, Date datumVremeOtvaranja, int brojTransakcija) {
        this.iDRacuna = iDRacuna;
        this.stanje = stanje;
    ...
    public Mesta getIDMestaOtvaranja() {
        return iDMestaOtvaranja;
    }

    public void setIDMestaOtvaranja(Mesta iDMestaOtvaranja) {
