...
public class Transakcije implements Serializable {
    ...
    @JoinColumn(name = "IDFilijale", referencedColumnName = "IDFilijale")
    @ManyToOne
    private Filijale iDFilijale;
    ...
    public Filijale getIDFilijale() {
        return iDFilijale;
    }

    public void setIDFilijale(Filijale iDFilijale) {
